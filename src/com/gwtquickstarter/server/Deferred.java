...
/**
 * This code was written by Vince Bonfanti
 * I grabbed it from http://code.google.com/p/gaevfs/source/browse/trunk/src/com/newatlanta/appengine/taskqueue/Deferred.java
 * and slightly modified it to remove deprecated API references and to always run do Base64 encoding.
 * -- George Armhold <armhold@gmail.com>
 *
 */
...
public class Deferred extends HttpServlet {
    ...
    public static TaskHandle defer( Deferrable task, String queueName ) {
        return defer( task, queueName, taskUrl != null ? TaskOptions.Builder.withUrl( taskUrl ) : withDefaults() );
    }
...
// change by armhold: with App Engine 1.4, it seems that Base64 encoding is always required, both in dev and prod
        return true;
    }
}
